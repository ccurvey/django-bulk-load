...
INSTALLED_APPS.append("demo3")

####################################################################################
## django-mail-auth
INSTALLED_APPS.append('mailauth')
...
#####################################################################################
## for site-wide templates
TEMPLATES[0]['DIRS'].append(BASE_DIR / 'website/templates')

#####################################################################################
from django.urls import reverse_lazy

LOGIN_REDIRECT_URL = reverse_lazy("demo3:index")
LOGOUT_REDIRECT_URL = reverse_lazy("demo3:index")
